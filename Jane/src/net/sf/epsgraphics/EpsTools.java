...
public class EpsTools {
     ...
     */
    public static boolean createFromDrawable(
        Drawable d, String fileName, int x, int y, ColorMode colorMode) {
        
        EpsGraphics g = new EpsGraphics(
                            "EpsTools Drawable Export", 0, 0, x, y, colorMode);
